...
def get_stt_client(name, settings: aqt.qt.QSettings):
    if name == "google":
...
class GoogleClient(STTClient):
    ...
    def __init__(self, settings: aqt.qt.QSettings):
        ...
        self.api_key_textbox = aqt.qt.QLineEdit()
        self.field_to_read_textbox = aqt.qt.QLineEdit()
        self.select_language_dropdown = aqt.qt.QComboBox()
    ...
    def get_my_settings_layout(self):
        my_settings_layout = aqt.qt.QHBoxLayout()

        self.api_key_textbox.setText(self.my_settings.value(GoogleClient.API_KEY_SETTING_NAME, "", type=str))
        api_setting_label = aqt.qt.QLabel("Google Speech-to-Text API Key:")
        ...
        field_to_read_setting_label = aqt.qt.QLabel("Name of Card Field to Read:")
        ...
        select_language_label = aqt.qt.QLabel("Language:")

        labels_vl = aqt.qt.QVBoxLayout()
...
class MicrosoftClient(STTClient):
    ...
    def __init__(self, settings: aqt.qt.QSettings):
        ...
        self.field_to_read_textbox = aqt.qt.QLineEdit()
        self.select_language_dropdown = aqt.qt.QComboBox()
        self.select_region_dropdown = aqt.qt.QComboBox()
    ...
    def get_my_settings_layout(self):
        ...
        api_setting_label = aqt.qt.QLabel("Microsoft Speech-to-Text API Key:")
        ...
        select_region_label = aqt.qt.QLabel("API Location:")
