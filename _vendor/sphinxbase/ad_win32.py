...
if _swig_python_version_info >= (9, 9, 9):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_ad_win32')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_ad_win32')
    _ad_win32 = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_ad_win32', [dirname(__file__)])
        except ImportError:
            import _ad_win32
            return _ad_win32
        try:
            _mod = imp.load_module('_ad_win32', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
